...
if __name__ == "__main__":
    ...
    dog_filter = ExtendeDoGFilter("CG/Difference_of_Gaussians/examples/lillies.png")
    ...
    while True:
        ...
        thresholded_image = dog_filter.threshold(dog_image)
        #display the image
        ...
        if key == ord("s"):
            cv.imwrite("CG/Difference_of_Gaussians/examples/lillies_xdog.png", thresholded_image)
            break
